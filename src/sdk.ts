...
export type ListDeploymentLogsQuery = { __typename?: 'Query', deploymentLogs: Array<{ __typename?: 'Log', message: string, severity?: string | null, timestamp: string, attributes: Array<{ __typename?: 'LogAttribute', key: string, value: string }>, tags?: { __typename?: 'LogTags', deploymentId?: string | null, deploymentInstanceId?: string | null, environmentId?: string | null, pluginId?: string | null, projectId?: string | null, serviceId?: string | null, snapshotId?: string | null } | null }> };
...
export type ListHttpLogsQuery = { __typename?: 'Query', httpLogs: Array<{ __typename?: 'HttpLog', upstreamRqDuration: number, upstreamProto: string, upstreamAddress: string, txBytes: number, totalDuration: number, timestamp: string, srcIp: string, rxBytes: number, responseDetails: string, requestId: string, path: string, method: string, httpStatus: number, host: string, edgeRegion: string, downstreamProto: string, deploymentInstanceId: string, deploymentId: string, clientUa: string }> };
...
export type ListMetricsQuery = { __typename?: 'Query', metrics: Array<{ __typename?: 'MetricsResult', measurement: MetricMeasurement, tags: { __typename?: 'MetricTags', volumeId?: string | null, serviceId?: string | null, projectId?: string | null, pluginId?: string | null, environmentId?: string | null, deploymentId?: string | null }, values: Array<{ __typename?: 'Metric', value: number, ts: number }> }> };
...
export const ListHttpLogsDocument = `
    query listHTTPLogs($deploymentId: String!) {
  httpLogs(
    afterDate: ""
    afterLimit: 10
    anchorDate: ""
...
export const ListMetricsDocument = `
    query listMetrics($environmentId: String!, $serviceId: String!) {
  metrics(
    measurements: BACKUP_USAGE_GB
    startDate: ""
