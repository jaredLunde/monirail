...
export type ListDeploymentLogsQuery = {
	__typename?: "Query";
	deploymentLogs: Array<{ __typename?: "Log"; timestamp: string }>;
};
...
export type ListMetricsQuery = {
	...
	metrics: Array<{
		__typename?: "MetricsResult";
		measurement: MetricMeasurement;
		values: Array<{ __typename?: "Metric"; value: number; ts: number }>;
	}>;
};
...
export function getSdk(
	...
	return {
		...
		listHTTPLogs(
			variables: ListHttpLogsQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders,
		): Promise<ListHttpLogsQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<ListHttpLogsQuery>(ListHttpLogsDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders,
					}),
				"listHTTPLogs",
