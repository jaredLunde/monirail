...
export type ListDeploymentLogsQuery = { __typename?: 'Query', deploymentLogs: Array<{ __typename?: 'Log', timestamp: string }> };
...
export type ListHttpLogsQuery = { __typename?: 'Query', httpLogs: Array<{ __typename?: 'HttpLog', totalDuration: number, timestamp: string }> };
...
export type ListMetricsQuery = { __typename?: 'Query', metrics: Array<{ __typename?: 'MetricsResult', measurement: MetricMeasurement, values: Array<{ __typename?: 'Metric', value: number, ts: number }> }> };
...
export type GetDeploymentByIdQuery = { __typename?: 'Query', deployment: { __typename?: 'Deployment', id: string, projectId: string, staticUrl?: string | null, environment: { __typename?: 'Environment', id: string, name: string }, service: { __typename?: 'Service', id: string, name: string } } };
...
export type GetServiceByIdQuery = { __typename?: 'Query', service: { __typename?: 'Service', name: string, project: { __typename?: 'Project', id: string, name: string } } };
...
export type GetEnvironmentByIdQuery = { __typename?: 'Query', environment: { __typename?: 'Environment', name: string, projectId: string } };
...
export type GetProjectByIdQuery = { __typename?: 'Query', project: { __typename?: 'Project', name: string } };
...
export type ListTcpProxiesQuery = { __typename?: 'Query', tcpProxies: Array<{ __typename?: 'TCPProxy', id: string, domain: string, proxyPort: number, deletedAt?: any | null }> };


export const ListDeploymentLogsDocument = `
  ...
  deploymentLogs(
    ...
    `;
export const ListHttpLogsDocument = `
    query listHTTPLogs($deploymentId: String!, $startDate: String!, $endDate: String!) {
  httpLogs(
    deploymentId: $deploymentId
    startDate: $startDate
    endDate: $endDate
    ...
    `;
export const ListMetricsDocument = `
...
export const GetServiceByIdDocument = `
  ...
  service(id: $id) {
    ...
    `;
export const GetEnvironmentByIdDocument = `
...
export const GetProjectByIdDocument = `
  ...
  project(id: $id) {
    ...
    `;
export const ListTcpProxiesDocument = `
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    listDeploymentLogs(variables: ListDeploymentLogsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ListDeploymentLogsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ListDeploymentLogsQuery>(ListDeploymentLogsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'listDeploymentLogs', 'query', variables);
    },
    listHTTPLogs(variables: ListHttpLogsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ListHttpLogsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ListHttpLogsQuery>(ListHttpLogsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'listHTTPLogs', 'query', variables);
    },
    listMetrics(variables: ListMetricsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ListMetricsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ListMetricsQuery>(ListMetricsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'listMetrics', 'query', variables);
    },
    listDeployments(variables?: ListDeploymentsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ListDeploymentsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ListDeploymentsQuery>(ListDeploymentsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'listDeployments', 'query', variables);
    },
    getDeploymentById(variables: GetDeploymentByIdQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetDeploymentByIdQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetDeploymentByIdQuery>(GetDeploymentByIdDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getDeploymentById', 'query', variables);
    },
    ...
    getEnvironmentById(variables: GetEnvironmentByIdQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetEnvironmentByIdQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetEnvironmentByIdQuery>(GetEnvironmentByIdDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getEnvironmentById', 'query', variables);
    },
    ...
    listTcpProxies(variables: ListTcpProxiesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ListTcpProxiesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ListTcpProxiesQuery>(ListTcpProxiesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'listTcpProxies', 'query', variables);
    }
  };
}
